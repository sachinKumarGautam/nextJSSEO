...
// get membership code
export const GET_MEMBERSHIP_CODE_LOADING = 'GET_MEMBERSHIP_CODE_LOADING'
export const GET_MEMBERSHIP_CODE_SUCCESS = 'GET_MEMBERSHIP_CODE_SUCCESS'
export const GET_MEMBERSHIP_CODE_FAILURE = 'GET_MEMBERSHIP_CODE_FAILURE'

export const RESET_CUSTOMER_FORM_STATE = 'RESET_CUSTOMER_FORM_STATE'
